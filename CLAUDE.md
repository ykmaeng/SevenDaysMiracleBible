...
Selah Bible — a desktop Bible reader app built with **Tauri 2 + React 19 + TypeScript**. It bundles a core SQLite database with KJV and SAV-KO (Selah AI Version) translations, and allows users to download additional translations on demand from GitHub releases.
...
- Translation data files live in `scripts/data/output/` (e.g., `sav-ko.json`, `kjv.json`)

### Data Flow

1. Core translations (KJV, SAV-KO) are pre-built into `bible-core.db` and bundled with the app
